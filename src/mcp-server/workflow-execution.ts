...
import type { RunRepository } from '../server/persistence/run-repository'
import type { SavedWorkflow, WorkflowRepository } from '../server/persistence/workflow-repository'
...
export class WorkflowExecutionService {
  ...
  async execute(context: RequestContext, workflowId: string, version?: number): Promise<WorkflowRun> {
    ...
    return this.executeSaved(context, saved)
  }
