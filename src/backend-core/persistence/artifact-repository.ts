...
export type { StoredArtifact } from '../../shared/backend-contract'
...
export class ArtifactRepository {
  constructor(private readonly database: BackendDatabase, private readonly contentStore: ArtifactContentStore,
