...
import type { SourceSecretsConfig } from '../../shared/backend-runtime-config'
...
export function createDataSourceSecretProvider(config: SourceSecretsConfig): DataSourceSecretProvider {
