...
import { AuditRepository } from './bff/persistence/audit-repository'
import { RunLimitService } from './backend-core/run-limit-service'
...
describe('Version 1 operational controls', () => {
  ...
  it('enforces and releases the Workspace concurrent-run lease limit', async () => {
    ...
    const first = backendContext({ requestId: 'run-1' })
