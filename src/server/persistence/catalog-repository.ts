...
import type { DataSource, DataSourceRepository } from './data-source-repository'
...
export class CatalogRepository {
  constructor(private readonly database: ApplicationDatabase, private readonly sources: DataSourceRepository) {}
