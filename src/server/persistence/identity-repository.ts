...
type WorkspaceRole = 'owner' | 'editor' | 'runner' | 'viewer'
...
export type Principal = { id: string; displayName: string; email?: string; status: 'active' | 'suspended' | 'deleted' }
export type WorkspaceContext = { id: string; name: string; slug: string; role: WorkspaceRole; membershipVersion: number }
export type AuthenticatedIdentity = { principal: Principal; workspace: WorkspaceContext; applicationRole: ApplicationRole; assuranceLevel: AssuranceLevel }
